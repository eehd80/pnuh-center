$(function () {
    ...
    $("#snb_nav>div>button").click(function () {
        ...
        if ($(this).hasClass("active")) {
            ...
            $("#snb")
                .slideDown(100)
                .css({ width: $(this).outerWidth(), left: $(this).position().left });
        }
    });
        ...
        if (v_keyCode == 9) {
            if (event.shiftKey) {
                ...
                if (gnb_loc == 0) {
                    ...
                    $("#gnb>li:nth-child(" + gnb_loc + ")")
                        .find("a")
                        .first()
                        .focus();
                    if ($(this).parent("li").prev("li").hasClass("child")) {
                        if ($("#gnb>li:nth-child(" + gnb_loc + ") .menuM>li:last-child").hasClass("child")) {
                            $("#gnb>li:nth-child(" + gnb_loc + ") .menuM>li:last-child .menuS>li:last-child")
                                .find("a")
                                .focus();
                            return false;
                        } else {
                            $("#gnb>li:nth-child(" + gnb_loc + ") .menuM>li:last-child")
                                .find("a")
                                .first()
                                .focus();
                            return false;
    ...
    //     // $(".tab-wrap").slick("setPosition");
    //     return false;
    // });

    $(".successiveTab > button").click(function () {
        var $this = $(this);
